...
DRAFT_MODEL=${DRAFT_MODEL:-/mnt/dolphinfs/ssd_pool/docker/user/hadoop-efficient-llm/yuanerhang/workspace/spec/DeepSpec_latent_reasoning_diff-pos_0908_code/train_log_checkpoints/train_myspec_qwen3_4b_0.1ce-0.9l1_PerfectBlend_20260921_065327/checkpoints/myspec_block7_qwen3_4b/step_200}
